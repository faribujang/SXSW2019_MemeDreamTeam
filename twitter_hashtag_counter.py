__author__ = "geduldig" #ERROR ON LINE 67, ARGPARSE ARGUMENT NOT FULFILLED
...
def rank_old_hashtags(api, word_list, n):
  ...
  count = {}
  while True:
    pager = TwitterPager(api, 'search/tweets', {'q':words, 'count':COUNT})
